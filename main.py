...
number_elitism = 1
x1, x2, y = solve_binary_representation(is_min, selector, crosser, mutator, size_of_population, probability_mutation,
...
number_iteration = 100
number_elitism = 1
x1, x2, y = solve_real_representation(is_min, selector, crosser, mutator, size_of_population, probability_mutation,
                                      probability_crossover, number_iteration, number_elitism)
print("Done!")
plot3d(x1, x2, y, colorbar=True)
